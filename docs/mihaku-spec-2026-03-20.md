...
Freeプランは廃止。7日間無料トライアル（Pro Max相当）+ 有料2プラン構成。

| | トライアル（7日間） | Pro（680円/月） | Pro Max（1,480円/月） |
|---|---|---|---|
| 今日の3つ・手放し | ○ | ○ | ○ |
| 5人会議 | **無制限** | 1日3回 | **無制限** |
| 会議中の発言 | **無制限** | 5回/会議 | **無制限** |
| AIそうだん | **○** | × | **○** |
| 1対1チャット | **○** | × | **○** |
| エンドコンテンツ | **○** | × | **○** |
| AIモデル | **高品質** | 標準 | **高品質** |

- トライアルはPro Max相当の全機能解放。7日間で本気のmihakuを体験
- App Store上は無料DL。トライアル開始時にApple ID認証（支払い情報登録）が必要
